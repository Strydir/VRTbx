...
;MsgBox(1, "PlaceHolder", "not")
	...
	Global $Button_Start_SteamVR = GUICtrlCreateButton("Start SteamVR", 135, 50, 150, 29)
	GUICtrlSetFont(-1, 14, 600, 2, "Segoe UI Black")
	GuiCtrlSetTip(-1, "Starts SteamVR.")

	Global $Instructions = GUICtrlCreateButton("Instructions", 483, 50, 130, 29)
	GUICtrlSetFont(-1, 14, 600, 2, "Segoe UI Black")
	GuiCtrlSetTip(-1, "Instructions")
	...
	Global $Button_Settings = GUICtrlCreateButton("Set Steam Folders", 625, 85, 165, 28)
	GUICtrlSetFont(-1, 14, 600, 2, "Segoe UI Black")
	...
	Global $Button_Create_GamePage = GUICtrlCreateButton("Create Game Page", 205, $DesktopHeight - 105, 166, 35, $BS_BITMAP)
	...
	Global $Button_Open_Folder = GUICtrlCreateButton("Open Folder", 210, $DesktopHeight - 65, 155, 35, $BS_BITMAP)
	_GUICtrlButton_SetImage($Button_Open_Folder, $gfx & "Open_Folder.bmp")
	GuiCtrlSetTip(-1, "Opens Game Page Folder" & @CRLF & _
						"To be used to replace the StartPage." & 'html file used with VRToolbox.' & @CRLF & _
						'See "Instructions" for more detail.' & @CRLF & @CRLF)

	Global $Button_LightPage = GUICtrlCreateButton("Make StartPage", 391, $DesktopHeight - 102, 160, 29)
	GUICtrlSetFont(-1, 14, 600, 2, "Segoe UI Black")
	GuiCtrlSetTip(-1, "Makes a new StartPage to replace the one in VRToolbox")

	Global $TVCuts_Page = GUICtrlCreateButton("TVCuts Page", 398, $DesktopHeight - 65, 145, 29)
	GUICtrlSetFont(-1, 14, 600, 2, "Segoe UI Black")
	GuiCtrlSetTip(-1, "Makes a Page of Individual Shortcuts")

	Global $Button_Start_VRToolbox = GUICtrlCreateButton("Start VRToolbox", 568, $DesktopHeight - 104, 145, 70, $BS_BITMAP)
	_GUICtrlButton_SetImage($Button_Start_VRToolbox, $gfx & "VRToolbox.bmp")
	GuiCtrlSetTip(-1, "Start VRToolbox")
...
;	GUICtrlSetOnEvent($Button_Create_GamePage1, "_Create_Page_Generic")
...
Func _Instructions()
			...
			$GamePage_path_tbx = $Install_Web_DIR & "Readme_VRTbx.html"
			If FileExists($GamePage_path_tbx) Then
				ShellExecute($GamePage_path_tbx)
			Else
				MsgBox(1,"Oops!", $GamePage_path_tbx)
			EndIf
EndFunc

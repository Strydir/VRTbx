...
If $First_Start = "true" Then
	MsgBox($MB_ICONWARNING, "Welcome to the Steam Shortcuts Loader for VR Toolbox.", '                          Steam Shortcuts Loader for VRToolbox     ' & @CRLF & @CRLF & _
								...
								"This Utility can create web pages of shortcuts to your Steam Games, allowing you to organize and launch your games from within VR Toolbox. " & @CRLF & _
								'*Note that it will pick up your 2d games as well.  Remove them by right clicking and delete.' & @CRLF & @CRLF & _
								"In addition, you can make individual shortcut pages that you can attach to objects like TV's and Picture Frames to create Custom GameLaunch Objects." & @CRLF & @CRLF & _
...
If $First_Start <> "True" Then
	...
	Global $TVCuts_Page = GUICtrlCreateButton("TVCuts Page", 145, 43, 127, 45, $BS_BITMAP)
	...
	Global $Instructions = GUICtrlCreateButton("Instructions", 476, 50, 125, 29)
	GUICtrlSetFont(-1, 14, 600, 2, "Segoe UI Black")
...
;	GUICtrlSetFont(-1, 16, 600, 4, "Times New Roman")
	...
	GUICtrlCreateLabel(" To access your new", 618, 22, 100)
	;GUICtrlSetFont(-1, 8)
	GUICtrlCreateLabel("      GamePages in", 618, 35, 100)
	GUICtrlCreateLabel("    VRToolbox, click", 618, 50, 100)
;	GUICtrlSetFont(-1, 12)
...
;	DllCall("UxTheme.dll", "int", "SetWindowTheme", "hwnd", GUICtrlGetHandle(-1), "wstr", "Explorer", "wstr", 0)
	...
	GUICtrlSetFont(-1, 11, 400, 0, "Times New Roman")
		...
		GuiCtrlSetTip(-1, "Sets SteamVR as the SteamVR Home App.")
...
GUICtrlCreateGroup("First time the program runs" , 848, 5, 159, 262, $WS_THICKFRAME)
GUICtrlSetFont(-1, 14, 600, 2,"Segoe UI Black")
	...
	GuiCtrlSetTip(-1, "Set Steam Library Folders" & @CRLF & _
					'Set when you run the program for the first time or' & @CRLF & _
...
GUICtrlCreateGroup("    For every day usage", 848, 275, 159, 432, $WS_THICKFRAME)
GUICtrlSetFont(-1, 14, 600, 2, "Segoe UI Black")

  Local $All_Box = GUICtrlCreatePic($gfx & "all_box.bmp", 856, 305, 144, 200, $BS_BITMAP)
  GUISetState(@SW_SHOW)

	$Checkbox_CreatePage = GUICtrlCreateLabel("", 898, 470, 20, 20, 0x1201)
	GUICtrlSetFont(-1, 22, 400, 0, "Marlett")
	GUICtrlSetBkColor(-1, 0xFFFFFF)
	$Checkbox_CreatePage_Label = GUICtrlCreateLabel("All", 920, 469, 35, 20)
	GUICtrlSetFont(-1, 19, 400, 1, "arial")


	Global $Combo_Add_to_Custom = GUICtrlCreateCombo("Choose TAB", 877, 515, 115, 15, $CBS_DROPDOWNLIST)
...
GUICtrlCreateLabel("#2", 855, 520, 18)
GUICtrlSetFont(-1, 12)

	Global $Button_Add_to_Custom = GUICtrlCreateButton("Add to Custom", 875, 552, 117, 35, $BS_BITMAP)
	...
	GUICtrlCreateLabel("#3", 855, 560, 18)
GUICtrlSetFont(-1, 12)


	GUICtrlCreateLabel("Select your tab", 857, 591, 145)
	GUICtrlSetFont(-1, 16)

	GUICtrlCreateLabel("and then", 890, 614, 100)
	GUICtrlSetFont(-1, 16)

	GUICtrlCreateLabel("click", 910, 636, 75)
	GUICtrlSetFont(-1, 16)

	GUICtrlCreateLabel("#4", 855, 648, 20)
	GUICtrlSetFont(-1, 12)

	Global $Button_Create_GamePage = GUICtrlCreateButton("Create Game Page", 855, 665, 146, 35, $BS_BITMAP)
	_GUICtrlButton_SetImage($Button_Create_GamePage, $gfx & "Create_GamePage1.bmp")
	GuiCtrlSetTip(-1, "Create your Game Page!" & @CRLF & _
						"This will create a page of your selected games for use in VRToolbox" & @CRLF & @CRLF)
	...
	Global $Button_Start_SteamVR = GUICtrlCreateButton("Start SteamVR", 852, 718, 151, 64, $BS_BITMAP)
	...
	Global $Button_Exit = GUICtrlCreateButton("Exit", 932, 790, 65, 65, $BS_BITMAP)
...
;	GUICtrlSetOnEvent($Button_LightPage, "_Button_Create_GamePage_all")
	...
	GUICtrlSetOnEvent($Button_Create_GamePage, "_Create_Page_VRTbx")
...
Func _Radio_2() ; VR Toolbox
	...
	IniWrite($config_ini, "Settings", "ChangeDefaultSteamVRHome", "true")
	IniWrite($config_ini, "Settings", "Reload_HOMEonExit", "false")
	MsgBox(49, "Warning", "Make sure that you switch back to SteamVR BEFORE" & @CRLF & _
						  'you move or delete the program!' & @CRLF & _
						  'Your original "tools.manifest" file has been saved' & @CRLF & _
						  'to: ' & $Steam_tools_local_backup)
...
Func _Instructions()
			...
			$GamePage_path_tbx = $Install_DIR & "Readme_VRTbx.html"
			If FileExists($GamePage_path_tbx) Then
				ShellExecute($GamePage_path_tbx)
			Else
				MsgBox(1,"Oops!", "Someone has moved the Readme_VRTbx.html file!")
			EndIf
EndFunc
